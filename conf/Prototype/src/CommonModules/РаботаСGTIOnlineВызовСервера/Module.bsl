...
//
Процедура ДобавитьВСтруктуруЗаписиЭлементИЗначениеИзDOM(СтруктураЗаписи, Знач Коллекция, Знач УсловиеСравнения, МассивСодержание, Результат, Знач ЗаписатьЗначение = Ложь)

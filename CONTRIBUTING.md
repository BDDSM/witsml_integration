# Участие в проекте интеграции 1С и WITSML
...
* Проверьте раздел [Issues](https://github.com/johnnyshut/witsml_integration/issues), чтобы не создавать дубликатов
...
**Главная цель этого проекта** - интеграция с 1С.
...
* Создайте **pull-request** из своей ветки в ветку **`develop`** проекта witsml_integration
